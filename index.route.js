(function() {
  ...
  function routerConfig($stateProvider, $urlRouterProvider) {
    ...
    //dashboard
      ...
      // .state('pages.select-dashboard', {
      //   url:'/select-package',
      //   templateUrl:'app/pages/select-package/select-package.html',
      //   controller: 'SelectPackageController',
      //   controllerAs: 'ctrl',
      //   parent: 'pages'
      // })
      //main-dashboard
      .state('pages.main-dashboard', {
        url: '/main-dashboard',
        templateUrl: 'app/pages/main-dashboard/main-dashboard.html',
        controller: 'MainDashboardController',
        resolve: {
          'auth': function(localStorageService,$state,$window){
            if (localStorageService.get("token")) {
              $window.location.href = $window.location.origin+"odi/#/app/pages/main-dashboard";
            }else{
      ...
      .state('pages.resetpass', {
        url: '/resetpass/:token',
        templateUrl: 'app/pages/pages-resetpass/pages-resetpass.html',
      ...
      //layout-expanded
      .state('layouts.expanded', {
        url: '/expanded',
        templateUrl: 'app/pages/layout-expanded/layout-expanded.html',
        controller: 'LayoutExpandedController',
        controllerAs: 'layout',
        parent: 'layouts',
        specialClass: 'force-expanded nav-expanded'
      })
      //layout-header-sm
      .state('layouts.header-sm', {
        url: '/header-sm',
        templateUrl: 'app/pages/layout-header-sm/layout-header-sm.html',
        controller: 'LayoutHeaderSmController',
        controllerAs: 'layout',
        parent: 'layouts',
        specialClass: 'force-header-sm header-sm'
      })
